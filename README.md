...
This demo has been modified to add custom indexes. This allows the user to be able to choose which data to search against to be able to generate an answer. To create a new search index:

1.  Clone the repo.
1.  Create a branch.
1.  Add the data to be indexed in the `data` folder. Delete any documents in the folder that you do not want indexed.
1.  Check in the branch.
1.  In a browser, navigate to the repo, then the `Actions` tab.
1.  Manually dispatch the `Load Index` workflow:
